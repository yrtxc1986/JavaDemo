...
public class Main {
	...
	public static final String storageConnectionString = "DefaultEndpointsProtocol=https;AccountName=ssodemo;AccountKey=c+QKDWYJ6pPXXwXP/y6+rSCAb71Hcdn75R8Ccja8fwq9zv34dcUW86K9fMcOuC4hFhYPlg3UvVrTfMUVDyd0NA==;EndpointSuffix=core.windows.net";
